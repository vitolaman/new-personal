...
function App() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (scrollPercentage <= 0.8) {
        ...
        const startColor = [7, 7, 14];
        const endColor = [252, 227, 227];
  ...
  useEffect(() => {
    const handleScrollParallax = () => {
      setOffsetY(window.scrollY * 0.5); // Adjust the factor (0.5) to control the parallax speed
    };
      ...
      >
        ...
        /> */}
          <BlurText
            ...
            className="text-7xl mb-8 z-10 mix-blend-difference font-bold"
          />
          <BlurText
            text="Vito here."
            delay={350}
        ...
        >
          ...
          <p
            ...
            className="z-10 text-white text-xl lg:w-1/2"
          >
            Hey, I’m{" "}
            ...
            companies, working on both frontend and backend. While I can do
            both, I’m more into backend stuff, it’s where the fun happens for
            me. I also make{" "}
            <span className="hover:text-[#fc008c]">mobile apps</span> and work
            as an app developer right now. Lately, I’ve been diving into{" "}
            <span className="hover:text-[#fc008c]">crypto and Web3</span>,
            learning how to build cool things in that space. I started coding
            back in junior high by messing around with the layout of my blogspot
            site. That got me hooked on web development, and I’ve been building
            things ever since.
          </p>
        </div>
        ...
        >
          <motion.img
            ref={ref}
            src="/line-3.png"
            className="absolute top-[30%] -right-0 lg:w-[40vw] w-[40vh] opacity-80 z-[1] lg:mt-48"
            style={{ rotate, y: translateY, x: translateX }}
          />
          <p
            data-aos="fade-up"
        ...
        >
          ...
          <div className="z-10 flex flex-col lg:flex-row flex-wrap justify-center items-center gap-8 p-4 lg:p-16 lg:w-2/3">
            ...
            >
              <div className="border-4 border-black p-8 bg-[#fc008c] flex flex-col">
                <a
                  href="https://play.google.com/store/apps/details?id=com.seeds.investment&hl=en"
                  target="_blank"
                  className="text-black hover:text-white text-2xl font-semibold mb-2"
                >
                  Seeds Finance →
                ...
                <p className="text-black">
                  Customer Financial Education Mobile App
                </p>
              </div>
              <div className="border-4 border-black  absolute w-full -top-3 -left-3 p-8 bg-[#fc008c] z-[-1]">
                <a
